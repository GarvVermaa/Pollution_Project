...
// Separate caches to prevent poisoning
...
// ════════════════════════════════════════════════════════════════════
router.get("/past/city/:cityName", async (req, res, next) => {
 try {
...
router.get("/stations", async (req, res, next) => {
 try {
   ...
   // Guard: no API key → skip network call entirely
   if (!CPCB_API_KEY) {
   ...
   // Fallback — check fallback cache first
...
// ════════════════════════════════════════════════════════════════════
router.get("/present/city/:cityName", async (req, res, next) => {
 try {
   const city = req.params.cityName.replace(/-/g, " ").trim();

   // Check cache
   const cacheKey = "present:" + city.toLowerCase();
...
// ════════════════════════════════════════════════════════════════════
router.get("/future/city/:cityName", async (req, res, next) => {
 try {
   const city = req.params.cityName.replace(/-/g, " ").trim();
...
// ════════════════════════════════════════════════════════════════════
router.get("/disease/correlations", (req, res, next) => {
 try {
...
router.get("/disease/:causeName", (req, res, next) => {
 try {
...
// GET /api/meta/states
// ════════════════════════════════════════════════════════════════════
router.get("/meta/cities", (req, res, next) => {
 try {
...
router.get("/meta/states", (req, res, next) => {
 try {
